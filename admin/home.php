  ...
  while($row = $query->fetch_assoc()){
    ...
    $(function(){
        ...
        datasets: [
          {
            ...
            pointColor          : '#c30010',
            pointStrokeColor    : 'rgba(190, 0, 0, 1)',
            pointHighlightFill  : '#c30010',
            pointHighlightStroke: 'rgba(190, 0, 0, 1)',
      ...
      var barChartOptions                  = {
        ...
        scaleGridLineColor      : 'rgba(190, 0, 0, 1)',
