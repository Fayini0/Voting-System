        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="voters_add.php" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="email" class="col-sm-3 control-label">Email</label> <!-- Added Email Field -->
                    <div class="col-sm-9">
...
<div class="modal fade" id="deleteAllModal" tabindex="-1" role="dialog" aria-labelledby="deleteAllModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
     ...
     <!-- Redo Delete Confirmation Modal -->
<div class="modal fade" id="redoModal" tabindex="-1" role="dialog" aria-labelledby="redoModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="redoModalLabel">Confirm Redo</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                Are you sure you want to redo the deletion of voters?
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                <button type="button" id="confirmRedo" class="btn btn-warning">Redo</button>
            </div>
        </div>
    </div>
</div>
