...
<body>
    <div class="container">
        ...
        <div class="info-box">
            <h2>Student Representative Council Requirements:</h2>
            <ul>
            ...
            <?php if (isButtonEnabled('src_button_enabled')): ?>
                <a href="candidate_application.php" class="button">Apply SRC Candidates</a>
            <?php else: ?>
        ...
        <div class="info-box">
            <h2>House Committee Requirements:</h2>
            <ul>
                <li>Must be contesting for 1st or 2nd time</li>
                <li>Must average 64% + every year</li>
            ...
            <?php if (isButtonEnabled('hc_button_enabled')): ?>
                <a href="hc_application.php" class="button">Apply HC Candidates</a>
            <?php else: ?>
